# Hi, I'm Sayan Karmakar 👋
### Software Engineer at Qualcomm | C++ Specialist | Embedded Systems & Networking
...
I am a results-driven **Software Engineer** specializing in **embedded systems, networking protocols, and cross-platform development**. I have extensive experience building scalable backend systems, low-latency applications, and optimized mobile/IoT diagnostics solutions using modern **C++**.
...
## 📜 Research & Education
**Jadavpur University** | B.E. (Hons) in Instrumentation and Electronics Engineering (CGPA: 8.36/10)

* **Paper 1:** [Low-cost air pollution monitoring device based on AQI](https://ieeexplore.ieee.org/search/searchresult.jsp?newsearch=true&queryText=Low-cost%20air%20pollution%20monitoring%20device%20based%20on%20AQI)
* **Paper 2:** [Development of an IoT based architecture for environmental monitoring using UAV](https://ieeexplore.ieee.org/search/searchresult.jsp?newsearch=true&queryText=IoT%20based%20robust%20architecture%20for%20environmental%20monitoring%20using%20UAV)
